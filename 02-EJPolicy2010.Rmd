...
These classifications can be visualized and explored geographically in the interactive map below. Click on the search tool (whtie box in upper left of map) and type in a town or city name to zoom to that municipality. Click on individual block groups to see more detailed demographics. 
